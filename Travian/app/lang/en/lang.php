...
define( "tribe_4", "Nature" );
define( "tribe_5", "Natars" );
define( "tribe_6", "Nomads" );
define( "tribe_7", "Arab" );
...
define( "item_title_27", item_26 );
define( "item_curprod_27", "" );
define( "item_nextprod_27", "" );
define( "item_unit_27", "" );
define( "item_desc_27", "The riches of your empire are kept in the treasury. The treasury has room<br> for one treasure. After you have captured an artefact it takes 24 hours<br> on a normal server or 12 hours on a thrice speed server to be effective." );
...
define( "item_unit_41", "%" );
define( "item_desc_41", "With the Horse Drinking Pool, your Cavalry will be in better health and therefore train faster and consume less crop." );
...
define( "troop_49", "" );
define( "troop_50", "" );
define( "troop_51", "Spear fighter" );
define( "troop_52", "Gladiator" );
define( "troop_53", "Sawboy" );
define( "troop_54", "Scout" );
define( "troop_55", "Knight warrior" );
define( "troop_56", "Swiftblade" );
define( "troop_57", "Ram" );
define( "troop_58", "Cannon Fire" );
define( "troop_59", "Nobleman" );
...
define( "troop_desc_51", "Spear fighters are units similar to Clubswingers. They are cheap and they carry lots of resources. The bad thing about them is their actuall strenght. They are one of the weakest as well." );
define( "troop_desc_52", "Gladiators are powerful defensive units oriented in infartry defence. They are expensive but effective. Because of their heavy sword they are slow." );
define( "troop_desc_53", "Sawboys are highly trained teens that are fast and strong in fight. Their training is long and expensive which is kinda reasonable if you look at the strenght and speed it offers." );
define( "troop_desc_54", "As you can see, Nomad tribe has all strong, fast, good units. But not the scouts. Their scouts are fast but very weak, expensive and they eat 3 crop per hour. Seems like Nomads are out of money to train them better huh ;)" );
define( "troop_desc_55", "Knight warriors are complicated units. Their carry capacity is huge but they are actually more defensive than offensive units. Can be used to farm, but they are definately not effective in that area except for the high carry amount." );
define( "troop_desc_56", "Swiftblade, what to say about him. Most powerful unit in the game. They are very, very expensive and strong offensive units but their defensive skills are so weak that even scouts can fear them." );
define( "troop_desc_57", "The main role of Rams is to destroy the enemy wall, making the fight easier for the soldiers that fight." );
define( "troop_desc_58", "Same as catapults Cannon Fire destroy buildings and resource fields to make opponent weaker. The bigger rally point is, more targets they can shoot." );
define( "troop_desc_59", "Noblemen are the cheifs of the tribe. They are trying to convince opponents village to join his tribe and fight for them. They are very expensive and their training is long." );
define( "troop_desc_60", "Settlers are brave citizens of your village. And trained to set up new villages, because the establishment of a new village task particularly difficult, you need three Settlers. In addition, you need 750 units of all the resources of raw" );
...
define( "troop_desc_105", "Fares axes is a strong warrior, who makes his enemies shrink in fear. It is also an excellent defender against the enemy knights and infantry as well. However, training and tenance costs are high" );
...
define( "medal_0", "This player is still under Beginners Protection<br/>for %s hours" );
define( "medal_0d", "Player registered there account on <br/>%s" );
...
define( "report_result_text1", "You won a battle without any losses" );
define( "report_result_text2", "You won a battle, but with a loss of" );
define( "report_result_text3", "You have lost a battle" );
define( "report_result_text4", "Your defense has successfully defended your village without losses" );
define( "report_result_text5", "You have successfully defended your village while killing some of the attackers" );
define( "report_result_text6", "You have lost the battle in your village due to to many of the attackers" );
define( "report_result_text7", "You lost the battle of your village, without killing the attackers of" );
define( "report_result_text8", "Your reinforcements have arrived" );
define( "report_result_text9", "You failed to spy" );
define( "report_result_text10", "Successful spied on the enemy without losses" );
define( "report_result_text100", "Successful spy operation" );
define( "report_result_text11", "Traders have sucessfully traded wood" );
define( "report_result_text12", "Traders have sucessfully traded clay" );
define( "report_result_text13", "Traders have sucessfully traded iron" );
define( "report_result_text14", "Traders have sucessfully traded wheat" );
define( "report_action_text1", "sends" );
define( "report_action_text2", "reinforces" );
define( "report_action_text3", "attacks" );
define( "report_action_text4", "scouts" );
...
define( "login_result_msg_blocked", "This player is banned." );
define( "login_result_msg_notactive", "Player is not activated" );
...
define( "register_player_txt_fullserver", "Unfortunately, on this server and you can not register" );
define( "register_player_txt_regmail_sub", "Welcome to Delview Travian" );
...
define( "statistics_p_playerstatusch", "Playser is in suspension" );
define( "statistics_p_playerdeleted", "Player was deleted" );
define( "statistics_p_goldwaschanged", "Players gold was changed." );
...
define( "v2v_p_cannotbuildnewvill", "You can not build a new village" );
define( "v2v_p_cannotbuildnewvill1", "You can not build a new village, too few culture points" );
define( "v2v_p_cannotbuildnewvill2", "You can not build a new village, you need to%s from each supplier" );
define( "v2v_p_cannotbuildnewvill3", "There are forces in the village that need to be destoryed first" );
...
define( "v2v_p_playerwas_blocked", "This player was blocked from playing" );
...
define( "v2v_p_thereisnoattacktroops", "You did not choose the attacking force" );
...
define( "v2v_p_placetyp3", "The Valley in poor condition" );
define( "v2v_p_monster", "Nature" );
...
define( "buildings_p_notenoughres", "You do not have enough resources" );
define( "buildings_p_upg0", "Food shortages: Please develop a wheat field first" );
define( "buildings_p_upg1", "You must raise the level of the store first" );
define( "buildings_p_upg2", "You must raise the level of stored grain, first" );
define( "buildings_p_upg3", "You must raise the level of the warehouse and granary first" );
...
define( "text_newvill_lang", "Well done you have made a new village" );
